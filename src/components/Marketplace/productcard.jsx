...
const ProductCard = ({ product, onBuyClick, onSaveClick }) => {
  ...
  return (
    ...
    <div className="product-card">
      ...
      <div className="button-container">
        <button onClick={() => onBuyClick(name)} className="buttonBuy">
          Comprar
        </button>{" "}
        {/* <label className="buttonSave">
          <input
            type="checkbox"
            checked={isChecked}
          ...
          />
          <svg
            className={`save-regular ${isChecked ? "visible" : ""}`}
          ...
          <svg
            className={`save-solid ${isChecked ? "" : "visible"}`}
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 384 512"
          >
